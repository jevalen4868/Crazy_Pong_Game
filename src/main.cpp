...
int main() {
    ...
    Controller leftController(leftPaddle, Cfg::controllerUpdatesPerFrame, SDL_SCANCODE_W, SDL_SCANCODE_S);
    thread leftControllerThread = thread(&Controller::Control, &leftController);

    Controller rightController(rightPaddle, Cfg::controllerUpdatesPerFrame, SDL_SCANCODE_UP, SDL_SCANCODE_DOWN);
